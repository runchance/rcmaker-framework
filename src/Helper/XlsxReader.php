...
class XlsxReader
{
     ...
     * @return $this
     */
    public function setDateFormat($dateFormat): XlsxReader
    {
    ...
    public function readColumns($columnKeys = null, int $indexStyle = null): array
    {
        if (is_int($columnKeys) && $columnKeys > 1 && $indexStyle === null) {
            ...
            $indexStyle = $indexStyle | XlsxReader::KEYS_RELATIVE;
        }

        return $this->readRows($columnKeys, $indexStyle | XlsxReader::KEYS_SWAP);
    }
