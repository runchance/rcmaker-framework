<?php
namespace RC\Helper\GlobalData;
/**
 *  Global data client.
 *  @version 1.0.3
 */
class Client 
{
    ...
    {
        static::$_static['connection'] = static::$_static['connection'] ?? $this->getConnection($key);
        $this->writeToRemote(array(
           'cmd'   => 'set',
           'key'   => $key,
           'value' => $value,
        ), static::$_static['connection']);
        $this->readFromRemote(static::$_static['connection']);
    }
    ...
    public function __get($key)
    {
        ...
        return $this->readFromRemote(static::$_static['connection']);
    }
