...
namespace RC\Helper\Db\think\db\connector;
...
use RC\Helper\Db\think\db\BaseQuery;
use RC\Helper\Db\think\db\builder\Mongo as Builder;
use RC\Helper\Db\think\db\Connection;
use RC\Helper\Db\think\db\exception\DbException as Exception;
use RC\Helper\Db\think\db\Mongo as Query;
...
class Mongo extends Connection
{
    ...
    public function connect(array $config = [], $linkNum = 0)
    {
        if (!isset($this->links[$linkNum])) {
            ...
            $this->links[$linkNum] = new Manager($config['dsn'], []);
