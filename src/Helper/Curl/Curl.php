...
namespace RC\Helper\Curl;

use RC\Helper\Curl\ArrayUtil;
use RC\Helper\Curl\Decoder;
use RC\Helper\Curl\Url;
...
class Curl
{
    ...
    {
        $this->jsonDecoder = '\RC\Helper\Curl\Decoder::decodeJson';
    ...
    {
        $this->xmlDecoder = '\RC\Helper\Curl\Decoder::decodeXml';
    ...
    public function setDefaultDecoder($mixed = 'json')
    {
        if ($mixed === false) {
            ...
            if ($mixed === 'json') {
                $this->defaultDecoder = '\RC\Helper\Curl\Decoder::decodeJson';
            } elseif ($mixed === 'xml') {
                $this->defaultDecoder = '\RC\Helper\Curl\Decoder::decodeXml';
            }
        }
    }
