...
namespace RC\Helper\Template\think;
...
class Template
{
    ...
    public function __construct(array $config = [])
    {
        ...
        $class = false !== strpos($type, '\\') ? $type : '\\RC\\Helper\\Template\\think\\template\\driver\\' . ucwords($type);
    ...
    public function parseTagLib(string $tagLib, string &$content, bool $hide = false): void
    {
        if (false !== strpos($tagLib, '\\')) {
            ...
            $className = '\\RC\\Helper\\Template\\think\\template\\taglib\\' . ucwords($tagLib);
        }
