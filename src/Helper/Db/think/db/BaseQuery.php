...
namespace RC\Helper\Db\think\db;

use RC\Helper\Db\think\Collection;
use RC\Helper\Db\think\db\exception\DataNotFoundException;
use RC\Helper\Db\think\db\exception\DbException as Exception;
use RC\Helper\Db\think\db\exception\ModelNotFoundException;
use RC\Helper\Db\think\helper\Str;
use RC\Helper\Db\think\Model;
use RC\Helper\Db\think\Paginator;
...
abstract class BaseQuery
{
    ...
    public function __construct(ConnectionInterface $connection = null)
    {
        ...
        $this->prefix = $this->connection ? $this->connection->getConfig('prefix') : null;
    }
    ...
    public function parseOptions(): array
    {
        ...
        if (!isset($options['strict'])) {
            $options['strict'] = $this->connection ? $this->connection->getConfig('fields_strict') : true;
        }
