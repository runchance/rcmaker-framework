...
use PDO;
use PDOStatement;
use RC\Helper\Db\think\db\exception\BindParamException;
use RC\Helper\Db\think\db\exception\DbEventException;
use RC\Helper\Db\think\db\exception\DbException;
use RC\Helper\Db\think\db\exception\PDOException;
...
abstract class PDOConnection extends Connection
{
    ...
    {
        return $this->getConfig('builder') ?: '\\RC\\Helper\\Db\\think\\db\\builder\\' . ucfirst($this->getConfig('type'));
    }
