...
class Paginator implements JsonSerializable
{
     ...
     */
    public function __construct($totalItems, $itemsPerPage, $currentPage, $urlPattern = '',$data=null)
    {
    ...
    {
        if ($this->currentPage < $this->numPages || $this->hasMore) {
    ...
    public function render()
    {
        if ($this->numPages <= 1) {
            ...
            if ($this->getPrevUrl()) {
                ...
                $html .= '<li><a class="disabled">&laquo; '. $this->previousText .'</a></li>';
            }
            if ($this->getNextUrl()) {
                $html .= '<li><a href="' . htmlspecialchars($this->getNextUrl()) . '">'. $this->nextText .' &raquo;</a></li>';
            }else{
                $html .= '<li><a class="disabled">'. $this->nextText .' &raquo;</a></li>';
            }
            $html .= '</ul>';
            return $html;
        }
