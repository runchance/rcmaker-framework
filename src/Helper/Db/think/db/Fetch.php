...
class Fetch
{
     ...
     */
    public function __construct(Query $query,$Builder=null)
    {
        $this->query      = $query;
        $this->connection = $query->getConnection();
        $this->builder    = $Builder ?? $this->connection->getBuilder();
    }
     ...
     * @return string
     */
    public function select($data = null,$real = true): string
    {
        $this->query->parseOptions();
     ...
     * @return string
     */
    public function fetch(string $sql,$real = true): string
    {
        $bind = $this->query->getBind();

        return $real ? $this->connection->getRealSql($sql, $bind) : $sql;
    }
